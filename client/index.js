    ...
    */
    ...
    rows = books.map(book => `
      <tr class="book-item">
        ...
        <td class="px-6 py-4 border-b text-center">
          <button class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded" onclick="handleClickEditButton(${book.id})">Edit</button>
          <button class="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded" onclick="handleClickDeleteButton(${book.id})">Hapus</button>
        </td>
      </tr>
    `).join('');
  }
